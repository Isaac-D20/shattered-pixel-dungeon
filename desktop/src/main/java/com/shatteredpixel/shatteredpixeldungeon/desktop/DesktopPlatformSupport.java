...
public class DesktopPlatformSupport extends PlatformSupport {
	...
	public void setupFontGenerators(int pageSize, boolean systemfont) {
		...
		if (systemfont) {
			basicFontGenerator = asianFontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("fonts/SuezOne-Regular.ttf"));
		} else {
			basicFontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("fonts/pixel_font.ttf"));
			asianFontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("fonts/SuezOne-Regular.ttf"));
		}
